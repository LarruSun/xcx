...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this
    wx.request({
      url: 'https://www.eaqul.com/smallRoutineUser/utils/cardDetailData.do',//自己的服务接口地址
      method: 'post',
      header: {
  ...
  deleCard:function(e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.eaqul.com/smallRoutineUser/utils/deleCard.do',//自己的服务接口地址
            method: 'post',
            header: {
              'content-type': 'application/x-www-form-urlencoded;charset=UTF-8'
            },
  ...
  toBeDefault: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.eaqul.com/smallRoutineUser/utils/toBeDefault.do',//自己的服务接口地址
            method: 'post',
            header: {
              'content-type': 'application/x-www-form-urlencoded;charset=UTF-8'
            },
