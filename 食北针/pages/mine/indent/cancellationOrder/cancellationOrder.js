// pages/mine/indent/cancellationOrder/cancellationOrder.js
Page({
  ...
  commitCancel: function (e) {
    ...
    //上传图片
    wx.uploadFile({
      url: 'https://www.eaqul.com/smallRoutineUser/utils/unLoadImg.do', //
      ...
      success: function (res) {
        ...
        if (result.msgCode == "0"){
          wx.request({
            url: 'https://www.eaqul.com/smallRoutineUser/utils/cancelOrder.do',//自己的服务接口地址
            method: 'post',
            header: {
