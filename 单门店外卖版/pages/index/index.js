...
=======
            app.shopId = pageData.data.shopList[0].shopId;
            app.name = pageData.data.pageName;
            console.log(pageData)
>>>>>>> .r4165
  ...
  goToTakeOut:function(e) {
    ...
    if (this.data.shopList.length > 1){
      wx.navigateTo({
        url: '../index_order/selectStore/selectStore?shopList=' + JSON.stringify(this.data.shopList)
      })
    }else {
      wx.navigateTo({
